...
function PANEL:Init()
	...
	self.RefreshButton:SetText("Reload skins from disk")
...
function PANEL:PerformLayout(w, h)
	...
	self.RefreshButton:SetPos(self.PresetList:GetX() + self.PresetList:GetWide() - 120, self.PresetList:GetY() + self.PresetList:GetTall() + 4)
	self.RefreshButton:SetSize(120, defbuttall)
